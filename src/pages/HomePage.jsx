...
const featureCards = [
  {
    ...
    description: "Read ticket records directly from the tickets.",
    icon: FileSpreadsheet,
  },
  {
    title: "Satisfaction",
    description: "Read satisfaction responses directly from the satisfaction.",
    icon: SmilePlus,
  },
  {
    title: "RMA Analytics",
    description:
      "Read RMA records from the RMA or ticket tab and analyze type, region, date and month.",
    icon: ClipboardList,
  },
  {
    title: "Live Reports",
  ...
  if (message) {
    return (
      <div className="mt-6 flex items-start gap-3 rounded-2xl border border-lime-200 bg-lime-50 p-4 text-lime-800">
        ...
        <div>
          <p className="font-black">Data Synced</p>
