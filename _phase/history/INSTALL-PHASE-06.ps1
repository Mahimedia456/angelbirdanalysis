...
Write-Host "AngelBird Phase 06 - clean Expo SDK 57 setup" -ForegroundColor Cyan
...
if (Test-Path ".env") {
  Copy-Item ".env" ".env.pre-phase06.backup" -Force
}
...
Write-Host ""
Write-Host "Phase 06 verification complete." -ForegroundColor Green
Write-Host "API: https://angelbirdanalysis-api.vercel.app" -ForegroundColor Green
Write-Host "Ticket + Satisfaction + RMA reports are native live-Sheet screens." -ForegroundColor Green
